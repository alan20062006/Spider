** Runtime:1774867979.2 Data:/prj/dcp/restricted/idata/staging/cdas/070116/cdas_final/datasets/diet/DHQ/dhq_foodfreq_dhq1.sas7bdat **;
proc format;
  ** FORMAT: buildf **;
  ** FOR VARIABLE: build **;
  ** SAS DATE VARIABLE (formats not searched/validated) **;
  value buildf
    LOW-HIGH=[mmddyy8.]
  ;
  ** FORMAT: food_component_id_dhq_1f **;
  ** FOR VARIABLE: food_component_id_dhq_1 **;
  value food_component_id_dhq_1f
  ...
  ;
  ** FORMAT: food_id_dhq_1f **;
  ** FOR VARIABLE: food_id_dhq_1 **;
  value food_id_dhq_1f
  ...
  ** CHARACTER VARIABLE (formats not searched/validated) **;
  value $iidf
  ;
  ** FORMAT: admin_date_dhq_1f **;
  ** FOR VARIABLE: admin_date_dhq_1 **;
  ** SAS DATE VARIABLE (formats not searched/validated) **;
  value admin_date_dhq_1f
    LOW-HIGH=[mmddyy8.]
    .M = 'Missing'
    .N = 'Not Applicable'
  ;
  ...
  ** FOR VARIABLE: admin **;
  value adminf
    ...
    2 = 'Administration 2'
  ;
  ** FORMAT: daily_freq_dhq_1f **;
  ** FOR VARIABLE: daily_freq_dhq_1 **;
  ** CONTINUOUS NUMERIC VARIABLE (formats not searched/validated) **;
  value daily_freq_dhq_1f
    .N = "Not Applicable"
  ;
  ** FORMAT: size_dhq_1f **;
  ** FOR VARIABLE: size_dhq_1 **;
  value size_dhq_1f
    .M = 'Missing'
    .N = 'Not Applicable'
    0 = 'Small'
  ...
  ** SAS DATE VARIABLE (formats not searched/validated) **;
  value buildv
    LOW-HIGH=[mmddyy8.]
  ;
  ** FORMAT: food_component_id_dhq_1v **;
  ** FOR VARIABLE: food_component_id_dhq_1 **;
  value food_component_id_dhq_1v
  ...
  ;
  ** FORMAT: food_id_dhq_1v **;
  ** FOR VARIABLE: food_id_dhq_1 **;
  value food_id_dhq_1v
  ...
  ** CHARACTER VARIABLE (formats not searched/validated) **;
  value $iidv
  ;
  ** FORMAT: admin_date_dhq_1v **;
  ** FOR VARIABLE: admin_date_dhq_1 **;
  ** SAS DATE VARIABLE (formats not searched/validated) **;
  value admin_date_dhq_1v
    LOW-HIGH=[mmddyy8.]
    .M = '(.M) Missing'
    .N = '(.N) Not Applicable'
  ;
  ...
  ** FOR VARIABLE: admin **;
  ...
  ;
  ** FORMAT: daily_freq_dhq_1v **;
  ** FOR VARIABLE: daily_freq_dhq_1 **;
  ** CONTINUOUS NUMERIC VARIABLE (formats not searched/validated) **;
  value daily_freq_dhq_1v
    .N = "(.N) Not Applicable"
  ;
  ** FORMAT: size_dhq_1v **;
  ** FOR VARIABLE: size_dhq_1 **;
