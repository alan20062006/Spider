** Runtime:1776093497.6 Data:/prj/dcp/restricted/idata/staging/cdas/070116/cdas_final/datasets/study/accounting/dhq_accounting.sas7bdat **;
proc format;
  ** FORMAT: $iidf **;
  ** FOR VARIABLE: iid **;
  ...
  ** FOR VARIABLE: has_cv3 **;
  value has_cv3f
    ...
    1 = 'Yes'
  ;
  ** FORMAT: dhq_admin_date_1f **;
  ** FOR VARIABLE: dhq_admin_date_1-2 **;
  ** SAS DATE VARIABLE (formats not searched/validated) **;
  value dhq_admin_date_1f
    LOW-HIGH=[mmddyy8.]
    .N = 'Not applicable'
  ;
  ** FORMAT: dhq_expmon_1f **;
  ** FOR VARIABLE: dhq_expmon_1-2 **;
  ** CONTINUOUS NUMERIC VARIABLE (formats not searched/validated) **;
  value dhq_expmon_1f
  ;
  ** FORMAT: has_dhq_admin_1f **;
  ** FOR VARIABLE: has_dhq_admin_1-2 **;
  value has_dhq_admin_1f
    0 = 'No'
    1 = 'Yes'
  ;
  ** FORMAT: in_dhqf **;
  ...
  ** FOR VARIABLE: has_cv3 **;
  value has_cv3v
    ...
    1 = '(1) Yes'
  ;
  ** FORMAT: dhq_admin_date_1v **;
  ** FOR VARIABLE: dhq_admin_date_1-2 **;
  ** SAS DATE VARIABLE (formats not searched/validated) **;
  value dhq_admin_date_1v
    LOW-HIGH=[mmddyy8.]
    .N = '(.N) Not applicable'
  ;
  ** FORMAT: dhq_expmon_1v **;
  ** FOR VARIABLE: dhq_expmon_1-2 **;
  ** CONTINUOUS NUMERIC VARIABLE (formats not searched/validated) **;
  value dhq_expmon_1v
  ;
  ** FORMAT: has_dhq_admin_1v **;
  ** FOR VARIABLE: has_dhq_admin_1-2 **;
  value has_dhq_admin_1v
    0 = '(0) No'
    1 = '(1) Yes'
  ;
  ** FORMAT: in_dhqv **;
