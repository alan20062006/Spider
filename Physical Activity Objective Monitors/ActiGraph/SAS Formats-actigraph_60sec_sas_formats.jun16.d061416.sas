** Runtime:1776352844.4 Data:/prj/dcp/restricted/idata/staging/cdas/070116/cdas_final/datasets/behavior/acm/actigraph_60sec.sas7bdat **;
proc format;
  ...
  ** CONTINUOUS NUMERIC VARIABLE (formats not searched/validated) **;
  ...
  ;
  ** FORMAT: vector_magnitudef **;
  ** FOR VARIABLE: Vector_Magnitude **;
  ** CONTINUOUS NUMERIC VARIABLE (formats not searched/validated) **;
  value vector_magnitudef
  ;
  ...
  ** CONTINUOUS NUMERIC VARIABLE (formats not searched/validated) **;
  ...
  ;
  ** FORMAT: vector_magnitudev **;
  ** FOR VARIABLE: Vector_Magnitude **;
  ** CONTINUOUS NUMERIC VARIABLE (formats not searched/validated) **;
  value vector_magnitudev
  ;
